...
## Use Unreal Engine with AI agents
...
the [official installation guide](https://github.com/dcc-mcp/dcc-mcp-agent-plugins#install). Start Unreal Engine,
...
```text
Use dcc-mcp to inspect the current Unreal Engine project and level.
```

The list must include `dcc_type=unreal`. If it does not, follow the
